...
<html>
    <head>
        <title>Super Someone Details Page</title>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        <div class="container">
            ...
            <br>
            <p>
                Name: <c:out value="${superSomeone.superSomeoneName}"/>
            </p>
            <p>
                Type: <c:out value="${superSomeone.superSomeoneType}"/>
            </p>
            <p>
                Alias: <c:out value="${superSomeone.superSomeoneAlias}"/>
            </p>
            <p>
                Description: <c:out value="${superSomeone.superSomeoneDescription}"/>
            </p>

            <p>
                Super Powers:
                <c:forEach var="currentSuperPower" items="${superSomeone.superPowerList}">
